...
def get_dataset(file_name='../dataset/Stk.0941.HK.all.csv', train_ratio=0.6, valid_ratio=0.2, col_name_tar="Close",
                tag_norm='min-max', trn_batch_size=12, vld_batch_size=12, shuffle=True):
    ...
    return {'n_ft': n_ft, 'total_len': total_len, 'train_len': train_len, 'valid_len': valid_len, 'tag_norm': tag_norm,
            'col_name_tar': col_name_tar, 'df': df,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name_model', type=str, default='lstm',
                        help='model name - lstm/cnn/TSA_uni_naive/TSA_uni_avg/TSA_uni_mov_win')
