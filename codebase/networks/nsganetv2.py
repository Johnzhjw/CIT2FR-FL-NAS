...
from ofa.imagenet_codebase.modules.layers import MyModule, MBInvertedConvLayer, ConvLayer, IdentityLayer, LinearLayer, ZeroLayer
import os
import sys
dirname, filename = os.path.split(os.path.abspath(sys.argv[0]))
sys.path.insert(0, dirname)
from mbv3_fr import MobileNetV3
